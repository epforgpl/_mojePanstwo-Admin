...
<div class="btn-toolbar" data-role="editor-toolbar" data-target="#editor">
    ...
    <div class="btn-group">
        ...
        <a class="btn btn-info" data-edit="strikethrough" title="" data-original-title="Strikethrough"><i class="icon-strikethrough"></i></a>
...
<div class="pull-right"><button class="btn-lg btn-info">Save</button></div>

<? echo $this->Html->css('Bdl.Podgrupy/view'); ?>
<? echo $this->Html->css('Bdl.font-awesome'); ?>
<? echo $this->Html->script('Bdl.Podgrupy/bootstrap-wysiwyg'); ?>
